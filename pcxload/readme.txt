...
Builds to a .com binary just a tiny 128 bytes(!) that loads and
displays a 320x200x256color pcx file specified on command line in VGA mode.
16-bit x86 (80268 DOS ith VGA)
...
from some kind of challenge to make very small code that achieves this task
or some-such.

Probably it can be done in less than 128 bytes, if someone feels like a
challenge.
